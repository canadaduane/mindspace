...
export type FiguresBundle = {
  ...
  getJot: (figureId: string) => JotFigure,
  getLine: (figureId: string) => LineFigure,
  getPop: (figureId: string) => PopFigure,
  getTap: (figureId: string) => TapFigure,
...
export function makeFigures(
  ...
  return {
    ...
    getJot: (figureId) => getJot(figures, figureId),
    getLine: (figureId) => getLine(figures, figureId),
    getPop: (figureId) => getPop(figures, figureId),
    getTap: (figureId) => getTap(figures, figureId),
